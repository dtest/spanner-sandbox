...
func loadTestData(ctx context.Context, ec Emulator) error {
	...
	m := []*spanner.Mutation{
		...
		spanner.Insert("players", playerColumns, []interface{}{playerUUID[3], "player4", "player4@email.com", "0.00", ""}),
		spanner.Insert("players", playerColumns, []interface{}{playerUUID[4], "player5", "player5@email.com", "0.00", ""}),
	}
